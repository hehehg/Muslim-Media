...
public class RequestNetworkController {
	...
	private OkHttpClient getClient() {
		if (client == null) {
			// SECURITY NOTE: this used to install a "trust all certificates" SSLSocketFactory
			// and a hostname verifier that always returned true, which disables TLS
			// certificate/hostname validation entirely (a man-in-the-middle vulnerability).
			// That has been removed; OkHttp's secure platform defaults are used instead.
